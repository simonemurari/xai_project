...
# Evaluation of a trained C51 model
...
def evaluate(
    ...
    model.eval()
    if write:
        writer = SummaryWriter(f"C51/runs_eval/{run_name}/eval")
        writer.add_text(
            "hyperparameters",
...
if __name__ == "__main__":
    ...
    # Change these to the paths of the C51 models you want to evaluate
    ...
    if args.track:
        import wandb
        wandb.tensorboard.patch(root_logdir=f"C51/runs_eval/{run_name}/eval")
        wandb.init(
