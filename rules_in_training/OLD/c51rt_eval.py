...
# Evaluation of a C51rt model on a MiniGrid environment, rules used only during training
...
def evaluate(
    ...
    model.eval()
    if write:
        writer = SummaryWriter(f"C51rt/runs_eval/{run_name}/eval")
        writer.add_text(
            "hyperparameters",
...
if __name__ == "__main__":
    ...
    # path_5x5 = "MiniGrid-DoorKey-5x5-v0_c51rt_100000_2025_02_14-19_07_36" # training not done yet
    # path_6x6 = "MiniGrid-DoorKey-6x6-v0_c51rt_100000_2025_02_14-19_48_07" # training not done yet
    path_8x8 = "MiniGrid-DoorKey-8x8-v0_c51rt_1000000_2025_02_19-15_10_58"
    path = path_8x8
